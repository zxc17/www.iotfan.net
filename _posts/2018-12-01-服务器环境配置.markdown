...
安装php扩展源：
yum install -y php71w-cli php71w-common php71w-devel php71w-fpm php71w-gd php71w-mbstring php71w-mysql php71w-pdo
...
1. 下载
	到[jdk][Oracle]官网找到Java SE Development Kit版本下载链接，点击`Accept License Agreement`，然后选择`Linux x64`的后缀是`.tar.gz`的版本，然后鼠标右击下载链接，选择复制链接地址。此时，在Linux Shell中执行下面的命令下载JDK：
	```bash
